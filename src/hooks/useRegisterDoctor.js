...
function validateField(field, value) {
    ...
    if (field === "names" || field === "surnames" || field === "genre" || field === "ci" || field === "phoneNumber") {
...
function useRegisterDoctor() {
    ...
    useEffect(() => {
        getDateFormatted(formValues.bornDate);
    ...
    async function callService() {
        try {
            setIsLoading(true)
            const response = await fetch(`${api.URL}/doctor/addDoctor`, {
                method: "POST",
